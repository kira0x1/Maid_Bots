...
class maid_cog:
    ...
    async def progressLoop(self):
        while(True):
            ...
            await self.bot.send_message(self.bot.get_channel(str(226804409659686913)), "t!rep @" + str(self.king))
            await self.bot.send_message(self.bot.get_channel(str(226804409659686913)), "t!daily @" + str(self.king))
            await asyncio.sleep(600)


    async def on_message(self, message):
        if(not self.initialized):
            self.king = message.author
